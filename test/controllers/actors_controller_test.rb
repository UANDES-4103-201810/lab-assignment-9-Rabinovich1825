...
class ActorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create actor" do
    assert_difference('Actor.count') do
      post actors_url, params: { actor: { birth: @actor.birth, desctription: @actor.desctription, first_name: @actor.first_name, last_name: @actor.last_name } }
    end
  ...
  test "should update actor" do
    patch actor_url(@actor), params: { actor: { birth: @actor.birth, desctription: @actor.desctription, first_name: @actor.first_name, last_name: @actor.last_name } }
